...
import {
  ArrowLeft, BadgeCheck, Calendar, Clock, ExternalLink, Tag, CheckCircle, BookOpen, ImageIcon, X, ZoomIn,
} from 'lucide-react';
    ...
    <main style={{ paddingTop: '72px', minHeight: '100vh' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width={52} height={52} viewBox="0 0 24 24" style={{ color: 'white' }}>
